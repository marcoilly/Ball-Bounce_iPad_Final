...
public class AndroidDebug : MonoBehaviour {
	...
	void OnGUI () {
		...
		if (debugIsOn) {
			...
			GUI.BeginGroup (new Rect(leftSide, 40.0f, Screen.width - leftSide*2, 200.0f));

			scrollViewVector = GUI.BeginScrollView (new Rect (0, 0.0f, debugWidth, 200.0f), scrollViewVector, new Rect (0.0f, 0.0f, 600, 2000.0f));
